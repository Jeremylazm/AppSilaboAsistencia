...
namespace CapaPresentaciones
{
    public partial class P_TablaAsistenciaEstudiantes : Form
    {
        ...
        public void EditarRegistroEstudiantes()
		{
            ...
            P_DialogoInformacion.Mostrar("El registro de la asistencia de los estudiantes se Editó éxitosamente");
                ...
                try
                {
                    ...
                    if (Opcion == DialogResult.OK)
                    {
                        ...
                        if (Resultado.Rows.Count != 0)
                        {
                            ...
                            P_DialogoInformacion.Mostrar("Registro Docente editado exitosamente");
