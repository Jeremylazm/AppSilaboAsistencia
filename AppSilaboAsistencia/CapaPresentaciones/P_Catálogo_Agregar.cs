...
namespace CapaPresentaciones
{
    public partial class P_Catálogo_Agregar : Form
    {
        ...
        public void Recuperar_Horas_Docentes()
        {
            int HT1 = 0;
            int HT2 = 0;
            DataTable T1 = N_HorarioAsignatura.HorasDocenteHorarioAsignatura(CódigoDocente1);
            for (int i = 0; i < T1.Rows.Count; i++)
            {
                HT1 = HT1 + Convert.ToInt32(T1.Rows[i]["HorasTeoria"].ToString());
                HT1 = HT1 + Convert.ToInt32(T1.Rows[i]["HorasPractica"].ToString());
            }
            DataTable T2 = N_HorarioAsignatura.HorasDocenteHorarioAsignatura(CódigoDocente2);
        ...
        public void Guardar()
        {
            ...
            if (Check_1_Docentes.Checked == true)
            {
                ...
                if (HTD1 <= 10 || CódigoD1 == "00000")
                {
                    ...
                    ObjEntidadC.Silabo = 1;
                    ObjEntidadC.PlanSesiones = 1;
            ...
            else
            {
                ...
                {
                    MessageBox.Show("La hora del primer docente o segundo docente superan sus límites.");
                    CódigoDocente1 = CódigoD1;
                    CódigoDocente2 = CódigoD2;
                    Recuperar_Horas_Docentes();
                }
