...
namespace CapaPresentaciones
{
    public partial class P_TablaPlantillas : Form
    {
        ...
        {
            saveFileDialog.Title = "Descargar plantilla de Plan de Sesiones de 2 y 3 créditos";
            saveFileDialog.Filter = "Archivo de Excel | *.xlsx";
            saveFileDialog.DefaultExt = "xlsx";
            saveFileDialog.FilterIndex = 1;
            // El registro de la plantilla
        ...
        {
            // El registro de la plantilla
            saveFileDialog.Title = "Descargar plantilla de Plan de Sesiones de 4 créditos";
            saveFileDialog.Filter = "Archivo de Excel | *.xlsx";
            saveFileDialog.DefaultExt = "xlsx";
            saveFileDialog.FilterIndex = 1;
