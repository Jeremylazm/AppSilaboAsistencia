...
namespace CapaDatos
{
    public class D_AsistenciaEstudiante
    {
        ...
        public DataTable AsistenciaEstudianteAsignatura(string CodSemestre, string CodDepartamentoA, string Texto1, string Texto2, string LimFechaInf, string LimFechaSup)
        {
            DataTable Resultado = new DataTable();
